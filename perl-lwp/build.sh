...
MAKEFILE_OPTS="$PERL_MAKEFILE_OPTS --no-programs"

# Add any additional deps here; perl runtime added below
BUILD_DEPENDS_IPS="niksula/perl/http-message niksula/perl/encode-locale niksula/perl/http-negotiate niksula/perl/net-http"
